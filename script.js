...
function rain() {
    ...
    for (let index = 0; index < 100; index++) {
        ...
        const randomButton = Math.floor(Math.random() * 4 + 2);

        drops += `
            <div class="drop" style="left:${index}%; bottom:${randomButton + 100}%; animation-delay: 0.${randomAnimate}s; animation-duration: 0.5${randomAnimate}s;">
